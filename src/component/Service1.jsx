...
export default function Service1() {
  return (
    <div className="p-0">
      <div className="bg-white md:grid flex-col  grid-cols-11 md:h-full h-64">
        <div className="md:grid col-span-6 flex-col md:p-36 p-20 justify-center items-center">
          <div className="md:text-5xl text-xl font-semibold text-lime-800" style={{ fontFamily: "'Comic Neue', cursive" }}>
