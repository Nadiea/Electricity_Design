export default function Footer() {
  return (
    <div className=" bg-black" style={{ fontFamily: "'Comic Neue', cursive" }}>
      <div className=" w-9/12 mx-auto  bg-black">
        <div className=" hidden md:block font-bold font-serif text-[215px] text-white" style={{ fontFamily: "'Comic Neue', cursive" }} >
          INTELID
        </div>
        <div className=" md:flex gap-2 p-4">
          <div className=" text-white">DO YOU HAVE QUESTION?</div>
          <div className=" text-lime-500">CONTACT US</div>
        </div>


        <div className=" md:flex justify-between p-4">
<div> <div className="  mb-1 flex gap-5 mt-1">
            <div>
              <svg
...
<div>
  <ui className="md:flex gap-4 text-white">
    <li>2023COPYRIGHT</li>
